...
const Navigation = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center bg-[#05060f]/80 backdrop-blur-md border-b border-white/5">
      ...
      <Link href="/login" className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-indigo-500/20 flex items-center gap-2 transition-all active:scale-95">
        <span>無料で始める</span>
